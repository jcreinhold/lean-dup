...
- use both the local crate bench and a broader profiling-crate or pipeline-level workload
...
- prefer command-line reproductions such as pipeline benches, interactive profile binaries, and crate benches
