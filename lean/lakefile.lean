...
-- in the lean-semantic-search package. The tag's toolchain (v4.32.0-rc1) matches
-- this package's, so Lake compiles it cleanly under the root toolchain.
require «lean-semantic-search» from git
  "https://github.com/jcreinhold/lean-semantic-search.git" @ "v0.4.1" / "lean"
...
require «lean_rs_interop_shims» from git
  "https://github.com/jcreinhold/lean-rs.git" @ "v0.3.0" / "crates/lean-rs/shims/lean-rs-interop-shims"
