...
use crate::error::{Result, read, read_to_string};
use crate::workspace::ResolvedWorkspace;

pub(crate) const CACHE_KEY_VERSION: &str = "rust-cli-cache.v1";
...
pub(crate) fn resolve_cache(workspace: &ResolvedWorkspace) -> Result<CacheFacts> {
    let root = cache_root();
...
pub(crate) fn workspace_fingerprint(workspace: &ResolvedWorkspace) -> Result<String> {
