...
impl GoldPair {
    pub(crate) fn new(left: impl Into<String>, right: impl Into<String>) -> Self {
        let left = left.into();
...
pub(crate) struct TimingMetrics {
    pub(crate) index_load_ms: u128,
    pub(crate) retrieval_ms: u128,
    pub(crate) probe_ms: u128,
