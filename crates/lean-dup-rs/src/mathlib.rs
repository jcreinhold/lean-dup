...
pub(crate) struct ProjectMathlib {
    pub(crate) project: ResolvedWorkspace,
    pub(crate) source: ResolvedWorkspace,
}

impl ProjectMathlib {
    pub(crate) fn execution_root(&self) -> PathBuf {
...
pub(crate) fn resolve_for_workspace(
