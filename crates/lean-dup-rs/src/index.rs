...
pub(crate) struct IndexQuery {
    pub(crate) fingerprints: Vec<FingerprintQuery>,
    pub(crate) role_features: Vec<RoleFeatureQuery>,
}
...
#[derive(Debug, Clone, PartialEq, Eq, Serialize)]
#[allow(dead_code)]
pub(crate) struct HydratedDeclaration {
    pub(crate) handle: DeclarationHandle,
    ...
    pub(crate) feature_version: String,
    pub(crate) fingerprints: Fingerprints,
    pub(crate) role_features: Vec<RoleFeature>,
    pub(crate) binder_count: u64,
    pub(crate) low_signal_markers: Vec<String>,
}
...
impl IndexStore {
    ...
    #[allow(dead_code)]
    pub(crate) fn resolve(&self, reference: IndexReference) -> Result<OpenedIndex> {
...
mod tests {
    ...
    use crate::workspace::{ResolvedWorkspace, WorkspaceRequest, resolve};
