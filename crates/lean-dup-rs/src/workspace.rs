...
impl ResolvedWorkspace {
    pub(crate) fn lean_toolchain_path(&self) -> PathBuf {
...
pub(crate) fn module_to_file(root: &Path, module: &str) -> PathBuf {
...
pub(crate) fn olean_exists(root: &Path, module: &str) -> bool {
