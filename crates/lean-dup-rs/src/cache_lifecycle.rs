...
pub(crate) struct CacheDiagnostics {
    ...
    pub(crate) total_disk_bytes: u64,
    pub(crate) labels: Vec<CacheLabelDiagnostics>,
}

#[derive(Debug, Clone, PartialEq, Eq, Serialize)]
pub(crate) struct CacheLabelDiagnostics {
    pub(crate) label: String,
    pub(crate) label_dir: PathBuf,
    pub(crate) disk_bytes: u64,
    pub(crate) latest: CacheLatestDiagnostics,
    pub(crate) entries: Vec<CacheEntryDiagnostics>,
}

#[derive(Debug, Clone, PartialEq, Eq, Serialize)]
pub(crate) struct CacheLatestDiagnostics {
    pub(crate) pointer_path: PathBuf,
    pub(crate) status: CacheLatestStatus,
    pub(crate) index_dir: Option<PathBuf>,
}

#[derive(Debug, Clone, Copy, PartialEq, Eq, Serialize)]
#[serde(rename_all = "kebab-case")]
pub(crate) enum CacheLatestStatus {
    Ok,
    Missing,
    TargetMissing,
    CorruptPointer,
...
#[derive(Debug, Clone, PartialEq, Eq, Serialize)]
pub(crate) struct CacheEntryDiagnostics {
    pub(crate) index_dir: PathBuf,
    pub(crate) index_path: PathBuf,
    pub(crate) status: CacheEntryStatus,
    pub(crate) active_latest: bool,
    pub(crate) expected_current: bool,
    pub(crate) schema_version: Option<String>,
    pub(crate) provenance_kind: IndexProvenanceKind,
    pub(crate) declaration_count: Option<usize>,
    pub(crate) disk_bytes: u64,
...
pub(crate) struct CacheCleanupReport {
    ...
    pub(crate) removable_count: usize,
    pub(crate) protected_count: usize,
    pub(crate) bytes_to_remove: u64,
    pub(crate) bytes_removed: u64,
    pub(crate) removed_entries: Vec<CacheCleanupEntry>,
    pub(crate) protected_entries: Vec<CacheCleanupEntry>,
}

#[derive(Debug, Clone, PartialEq, Eq, Serialize)]
pub(crate) struct CacheCleanupEntry {
    pub(crate) label: String,
    pub(crate) index_dir: PathBuf,
    pub(crate) disk_bytes: u64,
